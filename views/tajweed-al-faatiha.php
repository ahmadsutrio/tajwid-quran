...
<div class="container" style="border: solid 1px #d6d6d6;">
	...
	<div class="row">
		<div class="col-md-12">
        <h3 class="text-center mb-5">Deteksi Tajwid <br> Al-Faatiha </h3>
        <br>
        <br>
        <!-- <br> -->
        ...
        <?php
        // for ($i = 0; $i <= 6235; $i++) : 
            $sql = "SELECT ayat.unicode_tajwid, ayat.text_ayat, ayat.nomor_ayat,  terjemahan.text_terjemah, audio.audio_ayat, surah.nomor_surah, surah.nama_surah FROM ayat, terjemahan, audio, surah WHERE ayat.id_ayat=terjemahan.id_terjemah AND ayat.id_ayat=audio.id_ayat AND ayat.id_surah=surah.id_surah AND ayat.id_surah= 1;";
            ?>
            <?php
