    ...
    private function createMetaData()
    {
        $this->meta = [
            ...
            self::MADDA_NORMAL => [
                    ...
                    'title' => 'Normal Prolongation: 2 Vowels'
            ],
            self::MADDA_PERMISSIBLE => [
                    ...
                    'title' => 'Permissible Prolongation: 2, 4, 6 Vowels'
            ],
            self::MADDA_NECESSARY => [
                    ...
                    'title' => 'Necessary Prolongation: 6 Vowels'
                ],
                self::QALAQAH => [
                        'identifier' => '[q',
                        'type' => 'qalaqah',
                ...
                self::MADDA_OBLIGATORY => [
                        ...
                        'title' => 'Obligatory Prolongation: 4-5 Vowels'
                ],
                self::IKHAFA_SHAFAWI => [
                        'identifier' => '[c',
                        'type' => 'ikhafa-shafawi',
                        ...
                        'title' => 'Ikhafa\' Shafawi - With Meem'
                ],
                self::IKHAFA => [
                        'identifier' => '[f',
                        'type' => 'ikhafa',
                ...
                self::IDGHAM_SHAFAWI => [
                        ...
                        'title' => 'Idgham Shafawi - With Meem'
                ],
                self::IQLAB => [
                        'identifier' => '[i',
                        'type' => 'iqlab',
